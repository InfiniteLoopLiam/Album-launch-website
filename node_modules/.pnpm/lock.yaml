  ...
  .:
    ...
    devDependencies:
      ...
      eslint-config-prettier:
        specifier: ^10.1.8
        version: 10.1.8(eslint@10.8.0(supports-color@10.2.2))
      globals:
        specifier: ^17.8.0
        version: 17.8.0
      htmlhint:
      ...
      stylelint:
        specifier: ^17.14.1
        version: 17.14.1(supports-color@10.2.2)
      stylelint-config-standard:
        specifier: ^40.0.0
        version: 40.0.0(stylelint@17.14.1(supports-color@10.2.2))
...
packages:
  ...
  htmlhint@1.9.2:
    resolution: {integrity: sha512-PweWSPA1Pb+AVFIOSpIGu5KhLdmtk/uf/0CpjvrDf6XUWmdTyqUljlylwSxQ0AWLvPGcBxK2n8uISsI4lCOkBQ==}
    engines: {node: '>=18'}
    hasBin: true
...
snapshots:
  ...
  eslint-config-prettier@10.1.8(eslint@10.8.0(supports-color@10.2.2)):
    dependencies:
      eslint: 10.8.0(supports-color@10.2.2)
  ...
  stylelint-config-recommended@18.0.0(stylelint@17.14.1(supports-color@10.2.2)):
    dependencies:
      stylelint: 17.14.1(supports-color@10.2.2)

  stylelint-config-standard@40.0.0(stylelint@17.14.1(supports-color@10.2.2)):
    dependencies:
      stylelint: 17.14.1(supports-color@10.2.2)
      stylelint-config-recommended: 18.0.0(stylelint@17.14.1(supports-color@10.2.2))
